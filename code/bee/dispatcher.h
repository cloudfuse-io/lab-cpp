...
//           // Filter row groups with metadata here
...
//                 preproc_cache.AddColumn(chunck_file.path.ToString(), i,
//                 col_plan->col_id,
...
//                        .has_value()) {
//                 parquet_helper_->DownloadColumnChunck(file_metadata, chunck_file.path,
//                 i,
//                                                       col_plan->col_id);
//                 col_chuncks_to_dl++;
//               }
...
//                   col_phys_plans.GetById(chunck_file.column).ValueOrDie(),
//                   file_metadata, chunck_file));
//           metrics_manager_->ExitPhase("col_proc");

//           // cache pre-process results
//           auto cols_for_rg =
//               preproc_cache.AddColumn(chunck_file.path.ToString(),
