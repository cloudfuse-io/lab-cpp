...
//   Status PreprocessColumnFile(Buzz::ColumnPhysicalPlans::ColumnPhysicalPlanPtr
//   col_plan,
//                               std::shared_ptr<parquet::FileMetaData> file_metadata,
//                               ParquetHelper::ChunckFile& chunck_file,
//                               std::shared_ptr<RowGroupResultSet> rg_res_set) {
//     if (rg_res_set->IsSkipped()) {
//       return Status::OK();
//     }
...
//     auto preproced_col = col_plan->execute(raw_arrow);

//     rg_res_set->AddPreprocedCol(preproced_col);
...
//   std::shared_ptr<parquet::FileMetaData> ReadMetadata(std::shared_ptr<PartialFile>
//   file) {
